...
export const PayOnDeliveryApi = {};
PayOnDeliveryApi.methods = {};
...
PayOnDeliveryApi.methods.authorize = new ValidatedMethod({
  name: "PayOnDeliveryApi.methods.authorize",
...
PayOnDeliveryApi.methods.capture = new ValidatedMethod({
  name: "PayOnDeliveryApi.methods.capture",
  validate: new SimpleSchema({
...
PayOnDeliveryApi.methods.refund = new ValidatedMethod({
  name: "PayOnDeliveryApi.methods.refund",
  validate: new SimpleSchema({
...
PayOnDeliveryApi.methods.refunds = new ValidatedMethod({
  name: "PayOnDeliveryApi.methods.refunds",
  validate: new SimpleSchema({
    transactionId: { type: String }
  }).validator(),
  run(args) {
