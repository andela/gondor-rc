...
import { Translation, Checkbox } from "/imports/plugins/core/ui/client/components";

class PayOnDeliverySettingsForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      settings: {
...
PayOnDeliverySettingsForm.propTypes = {
  onChange: PropTypes.func.isRequired,
  onSubmit: PropTypes.func.isRequired,
  settings: PropTypes.object
};

export default PayOnDeliverySettingsForm;
