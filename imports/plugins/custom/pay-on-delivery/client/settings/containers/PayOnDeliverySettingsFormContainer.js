...
import { PayOnDeliverySettingsForm } from "../components";

class PayOnDeliverySettingsFormContainer extends Component {
  constructor(props) {
    super(props);
...
PayOnDeliverySettingsFormContainer.propTypes = {
...
export default composeWithTracker(composer)(PayOnDeliverySettingsFormContainer);
