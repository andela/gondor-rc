  ...
  <div className="gdr-container">
    <div className="gdr-col-1">
      <div className="img-col-1">
        <div className="lg-img-box">
          <div className="gdr-btn">
            <a className="btn btn-default gdr-button btn-md" href="/tag/footwares" role="button">
                Visit shop
            </a>
          </div>
      ...
      <div className="img-col-2">
        <div className="sm-img-box">
          <div className="gdr-btn">
            <a className="btn btn-default gdr-button btn-md" href="/tag/phones" role="button">
                Visit shop
            </a>
          </div>
        ...
        <div className="sm-img-box">
          <div className="gdr-btn">
            <a className="btn btn-default gdr-button btn-md" href="/tag/health" role="button">
                Visit shop
            </a>
          </div>
    ...
    <div className="gdr-col-2">
      <div className="img-col">
        <div className="sm-img-box">
          <div className="gdr-btn">
            <a className="btn btn-default gdr-button btn-md" href="/tag/accessories" role="button">
                Visit shop
            </a>
          </div>
      ...
      <div className="img-col">
        <div className="sm-img-box">
          <div className="gdr-btn">
            <a className="btn btn-default gdr-button btn-md" href="/tag/corporate" role="button">
                Visit shop
            </a>
          </div>
      ...
      <div className="img-col">
        <div className="sm-img-box">
          <div className="gdr-btn">
            <a className="btn btn-default gdr-button btn-md" href="/tag/electronics" role="button">
                Visit shop
            </a>
          </div>
    ...
    <div className="gdr-col-3">
      <div className="img-col-1">
        <div className="sm-img-box">
          <div className="gdr-btn">
            <a className="btn btn-default gdr-button btn-md" href="/tag/baby" role="button">
                Visit shop
            </a>
          </div>
        ...
        <div className="sm-img-box">
          <div className="gdr-btn">
            <a className="btn btn-default gdr-button btn-md" href="/tag/digitalProducts" role="button">
                Visit shop
            </a>
          </div>
      ...
      <div className="img-col-2">
        <div className="lg-img-box">
          <div className="gdr-btn">
            <a className="btn btn-default gdr-button btn-md" href="/tag/fashion" role="button">
                Visit shop
            </a>
          </div>
