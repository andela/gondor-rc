...
class WalletSettingsForm extends Component {
  constructor(props) {
    ...
    this.state = {
      settings: {
        secretApiKey: props.settings.secretApiKey,
        publicApiKey: props.settings.publicApiKey,
      ...
      <div>
        { !settings.secretApiKey &&
          <div className="alert alert-info">
            <Translation defaultValue="Wallet Credentials" i18nKey="admin.paymentSettings.WalletCredentials"/>
          </div>
        }
